...
int N, Q; // N  is the number of vertices and q is number of queries 
...
long long answers[200500];  // storing answers of all queries 
int BLOCK_SIZE; // this is the size of the block 
int arr[200500]; // 
...
{
    int block_x = x.first.first / BLOCK_SIZE; // calculating the block number of   x 
    int block_y = y.first.first / BLOCK_SIZE; // calculating the block number of   y 
    if(block_x != block_y) // if  block_x != block_y
